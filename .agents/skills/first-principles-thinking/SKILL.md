...
1. State the question or problem plainly.
2. List the current assumptions, conventions, analogies, or inherited defaults.
3. Separate what must be true from what is merely customary.
4. Identify the irreducible fundamentals:
...
5. Rebuild possible answers from those fundamentals.
6. Compare the rebuilt answer against the conventional answer.
7. Name the practical implication, tradeoff, or experiment.
